...
class ConditionalExperimentalMode:
  ...
  def update(self, carState, enabled, frogpilotNavigation, lead, modelData, road_curvature, t_follow, v_ego):
    ...
    self.update_conditions(lead, lead_distance, modelData, road_curvature, standstill, t_follow, v_ego, v_lead)
  ...
  def update_conditions(self, lead, lead_distance, modelData, road_curvature, standstill, t_follow, v_ego, v_lead):
    self.lead_detection(lead)
    self.road_curvature(road_curvature)
    self.slow_lead(lead, lead_distance, t_follow, v_ego)
    self.stop_sign_and_light(lead, lead_distance, modelData, standstill, v_ego, v_lead)
  ...
  def lead_slowing_down(self, lead, lead_distance, v_ego, v_lead):
  ...
  def stop_sign_and_light(self, lead, lead_distance, modelData, standstill, v_ego, v_lead):
    lead_check = self.stop_lights_lead or not self.lead_slowing_down(lead, lead_distance, v_ego, v_lead) or standstill
